...
object MetlinkScheduleSource {
    val schedules = listOf(
        ...
        MetlinkSchedule(parentStationCode = "TAIT1", departTime = "04:46", tripId = "TripId1", orderId = 7, lineId = 5, toWellington = true),
        ...
        MetlinkSchedule(parentStationCode = "WELL1", departTime = "", tripId = "TripId1", orderId = 16, lineId = 5, toWellington = true),
    )
}